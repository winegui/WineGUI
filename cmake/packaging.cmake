...
if(${LINUX_DISTRO} MATCHES "openSUSE")
  ...
  set(CPACK_RPM_PACKAGE_REQUIRES "libgtkmm-4_0-0, cabextract, unzip, p7zip, wget, zenity, tar, xz, python3 >= 3.10")
else()
  # Fedora/CentOS/Redhat/etc.
  set(CPACK_RPM_PACKAGE_REQUIRES "gtkmm4.0, cabextract, unzip, p7zip, wget, zenity, tar, xz, python3 >= 3.10")
endif()
...
set(CPACK_DEBIAN_PACKAGE_DEPENDS "libgtkmm-4.0-0, cabextract, unzip, p7zip, wget, zenity, xz-utils, python3 (>= 3.10)")
